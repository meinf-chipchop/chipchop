  ...
  return (
    <div className="flex rounded-lg bg-white-200 ">
      <div className="w-1/4 p-4 bg-white">
        <div className="space-y-4 bg-gray rounded-lg">
          
          <Link href="/dashboard" className="block">
            <button className="w-full h-24 flex items-center justify-start space-x-4 bg-gray-200 hover:bg-gray-300 text-gray-800 font-semibold py-2 px-4 rounded shadow">
              <Home className="w-6 h-6" />
              <span className="text-lg">Dashboard</span>
            </button>
          </Link>

          <Link href="dashboard/user-petitions/cooks" className="block">
            <button className="w-full h-24 flex items-center justify-start space-x-4 bg-gray-200 hover:bg-gray-300 text-gray-800 font-semibold py-2 px-4 rounded shadow">
              <Users className="w-6 h-6" />
              <span className="text-lg">User Petitions</span>
            </button>
          </Link>
