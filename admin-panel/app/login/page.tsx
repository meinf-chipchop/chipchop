          ...
          <div className="flex items-center justify-between">
            <div className="flex items-center">
              <input
                ...
                name="remember-me"
                type="checkbox"
                className="h-4 w-4 text-[#8fbdc7] focus:ring-[#8fbdc7] border-[#966d35] rounded"
              />
              <label htmlFor="remember-me" className="ml-2 block text-sm text-[#415f63]">
                Remember me
              </label>
            </div>
            <div className="text-sm">
              <Link href="/forgot-password" className="font-medium text-[#415f63] hover:text-[#966d35]">
