...
const styles = StyleSheet.create({
  ...
  dishCard: {
    marginRight: 16,
    width: width > 900 ? width * 0.2 : width > 600 ? width * 0.3 : width * 0.7,
    height: width > 900 ? width * 0.15 : width > 600 ? width * 0.2 : width * 0.4,
    borderRadius: 8,
    overflow: 'hidden',
    shadowColor: '#000',
  ...
  dishCardVertical: {
    marginBottom: 16,
    width: width > 900 ? width * 0.3 : width > 600 ? width * 0.4 : width * 0.9,
    height: width > 900 ? width * 0.2 : width > 600 ? width * 0.25 : width * 0.5,
    borderRadius: 8,
    overflow: 'hidden',
    shadowColor: '#000',
    shadowOffset: { width: 0, height: 2 },
  ...
  chefCard: {
    marginRight: 16,
    width: width > 900 ? 180 : width > 600 ? 150 : 100,
    alignItems: 'center',
  },
  chefImage: {
    width: width > 900 ? 140 : width > 600 ? 120 : 80,
    height: width > 900 ? 140 : width > 600 ? 120 : 80,
    borderRadius: width > 900 ? 70 : width > 600 ? 60 : 40,
    marginBottom: 8,
    borderWidth: 1,
    borderColor: '#966d35',
  },
