...
router.register(r"dish-categories", cooks.viewsets.DishCategoryViewSet, basename="dish-category")
...
router.register(
    r"deliverers", deliverers.viewsets.CCDelivererViewSet, basename="deliverer"
)
